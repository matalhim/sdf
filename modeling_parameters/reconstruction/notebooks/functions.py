...
def plot_single_distribution(opt, true, var, E, limit, save):
    """
    ...
    legend_elements = [
        ...
        plt.Line2D([0], [0], color='royalblue', linestyle='-.', lw=2, label=rf'$\mu_{{{var}}}=${mean:.1f}'),
...
def plot_single_distribution_by_name(arrays, varname, E, limit=None, save=False):

    opt_all = arrays[f'{varname}_opt']
    true_all = arrays[f'{varname}']
    plot_single_distribution(opt_all, true_all, varname, E, limit=limit, save=save)

    

def plot_two_distributions(opt_all, true_all, opt_top4, true_top4, var, E, limit, save):
    """
    ...
    legend_elements = [
        ...
        plt.Line2D([0], [0], color='crimson', linestyle='-.', lw=2, label=rf'$\mu_{{{var}}}=${diff_top4.mean():.1f}'),
...
def plot_two_distributions_by_name(arrays, varname, E, limit=None, save=False):
    ...
    plot_two_distributions(opt_all, true_all, opt_top4, true_top4, varname, E, limit, save)
